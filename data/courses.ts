...
export const courses: Course[] = [
  {
    ...
    descriptor: 'A hands-on foundation course where younger learners explore coding, electronics, design, animation and teamwork through guided Mars-themed projects.',
    ageRange: '8 - 12',
    duration: '4 months',
    format: '1 x 2hr/week',
    ...
    recommendedCourses: ['kx-superhero', 'kx-wild', 'coding-software']
  },
  {
    slug: 'kx-superhero',
    ...
    duration: tbc,
    format: tbc,
    focusAreas: ['Coding', 'Electronics', 'Design', 'Creative Storytelling'],
    learningOutcomes: [detailsPending],
    courseStructure: tbc,
    toolsUsed: ['Scratch', 'Arduino', 'TinkerCAD'],
    prerequisites: tbc,
    exampleProjects: [],
    location: 'Colombo 06',
    registerLink: placeholderRegister,
    recommendedCourses: ['kx', 'kx-wild', 'coding-software']
  },
  {
    slug: 'kx-wild',
    ...
    duration: tbc,
    format: tbc,
    focusAreas: ['Coding', 'Sensors', 'Design', 'Environmental Projects'],
    learningOutcomes: [detailsPending],
    courseStructure: tbc,
    toolsUsed: ['Scratch', 'Arduino', 'TinkerCAD'],
    prerequisites: tbc,
    ...
    location: 'Colombo 06',
    registerLink: placeholderRegister,
    recommendedCourses: ['kx', 'kx-superhero', 'coding-software']
  },
  {
    slug: 'kx-j',
